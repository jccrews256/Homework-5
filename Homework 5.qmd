...
Note that I convert the final combined tibble into an interactive in the next step so that the grader can review my work for Task 1.
...
#Printing the final combined tibble as an interactiv table
kable(comb_tbl_2)
```
